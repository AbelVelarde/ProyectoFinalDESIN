...
Section
    ...
    CreateShortCut '$SMPROGRAMS\EmailClient.lnk' '$INSTDIR\app\java-runtime\bin\javaw' '--module-path $INSTDIR\app\javafx-sdk-13\lib --add-modules javafx.controls,javafx.fxml,javafx.graphics,javafx.web,javafx.base --add-opens=javafx.graphics/javafx.scene=ALL-UNNAMED -jar $INSTDIR\app\ProyectoEmail.jar'
